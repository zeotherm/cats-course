...
object InvariantFunctors {
  ...
  implicit def optionTCrypto[T](implicit c: Crypto[T], m: Monoid[T]): Crypto[Option[T]] =
  ...
  val showOptionString2: Show[Option[String]] = showStrings.imap(Option(_))(_.getOrElse("")) // identical
